!function(window) {
  ...
  patternfly.pfSetDonutChartTitle =
    ...
    var donutChartRightTitle =
        window.d3.select(selector).select("text.c3-chart-arcs-title");
    donutChartRightTitle.text(""),
        donutChartRightTitle.insert("tspan")
            .text(primary)
            .classed("donut-title-big-pf", !0)
            .attr("dy", 0)
            .attr("x", 0),
        donutChartRightTitle.insert("tspan")
            .text(secondary)
  ...
  patternfly.pfDonutTooltipContents =
      function(d, defaultTitleFormat, defaultValueFormat, color) {
    return '<table class="c3-tooltip">  <tr>    <td><span style="background-color:' +
           color(d[0].id) + '"></span><strong>' + d[0].value + "</strong> " +
           d[0].name + "</td>    <td>" + Math.round(1e3 * d[0].ratio) / 10 +
           "%</td>  </tr></table>"
  },
  patternfly.pfGetUtilizationDonutTooltipContentsFn =
    ...
    return function(d) {
      return '<span class="donut-tooltip-pf" style="white-space: nowrap;">' +
             Math.round(1e3 * d[0].ratio) / 10 + "% " + units + " " +
             d[0].name + "</span>"
    }
  },
  patternfly.pfGetBarChartTooltipContentsFn =
      function(categories) {
    return function(d) {
      var name = categories ? categories[d[0].index] : d[0].index;
      return '<table class="c3-tooltip">  <tr>    <td><strong>' + name +
             ":</td>    <td>" + d[0].value + "</td>  </tr></table>"
    }
  },
  patternfly.pfSingleLineChartTooltipContentsFn =
      function(categories) {
    return function(d) {
      var name = categories ? categories[d[0].index] : d[0].index;
      return '<table class="c3-tooltip">  <tr>    <td><strong>' + name +
  ...
  patternfly.pfPieTooltipContents =
      function(d, defaultTitleFormat, defaultValueFormat, color) {
    return patternfly.pfDonutTooltipContents(d, defaultTitleFormat,
                                             defaultValueFormat, color)
  },
  patternfly.c3ChartDefaults =
      function() {
    var getDefaultColors = function() {
      return {
        pattern: [
          patternfly.pfPaletteColors.blue, patternfly.pfPaletteColors.blue300,
          patternfly.pfPaletteColors.green, patternfly.pfPaletteColors.orange,
      ...
      return {
        color: this.getDefaultColors(), grid: this.getDefaultBarGrid(),
      ...
      return {
        color: this.getDefaultColors(), grid: this.getDefaultGroupedBarGrid(),
      ...
      return {
        color: this.getDefaultColors(), grid: this.getDefaultStackedBarGrid(),
      ...
      return {
        pattern: [
          patternfly.pfPaletteColors.blue, patternfly.pfPaletteColors.black300
        ]
      }
      ...
      return {
        donut: this.getDefaultDonut(title), size: this.getDefaultDonutSize(),
      ...
      return {
        pie: this.getDefaultPie(), size: this.getDefaultPieSize(),
      ...
      return {
        contents: function(d) {
          return '<span class="c3-tooltip-sparkline">' + d[0].value + " " +
                 d[0].name + "</span>"
        }
      }
    }, getDefaultSparklineConfig = function() {
      return {
        area: getDefaultSparklineArea(), size: getDefaultSparklineSize(),
            axis: getDefaultSparklineAxis(), color: getDefaultColors(),
      ...
      return {
        axis: getDefaultLineAxis(), grid: getDefaultLineGrid(),
            color: getDefaultColors(), legend: getDefaultLineLegend(),
      ...
      return {
        axis: getDefaultLineAxis(), grid: getDefaultLineGrid(),
            color: getDefaultColors(), legend: getDefaultSingleLineLegend(),
            point: getDefaultLinePoint(), tooltip: getDefaultSingleLineTooltip()
      }
      ...
      return {
        axis: getDefaultAreaAxis(), grid: getDefaultAreaGrid(),
            color: getDefaultColors(), legend: getDefaultAreaLegend(),
      ...
      return {
        axis: getDefaultAreaAxis(), grid: getDefaultAreaGrid(),
            color: getDefaultColors(), legend: getDefaultSingleAreaLegend(),
            point: getDefaultAreaPoint(), tooltip: getDefaultSingleAreaTooltip()
      }
    };
    return {
      getDefaultColors: getDefaultColors, getDefaultBarGrid: getDefaultBarGrid,
          ...
          getDefaultPie: getDefaultPie, getDefaultPieSize: getDefaultPieSize,
  ...
  window.patternfly = patternfly
    ...
    function($) {
      ...
      $.fn.sidebar =
          function() {
        var documentHeight = 0, navbarpfHeight = 0, colHeight = 0;
        $(".navbar-pf .navbar-toggle").is(":hidden") &&
            (documentHeight = $(document).height(),
             navbarpfHeight = $(".navbar-pf").outerHeight(),
             colHeight = documentHeight - navbarpfHeight),
            $(".sidebar-pf").parent(".row").children('[class*="col-"]').css({
              "min-height" : colHeight
            })
      },
      $(document).ready(function() {
        $(".sidebar-pf").length > 0 && 0 === $(".datatable").length &&
            $.fn.sidebar()
      }),
      $(window).resize(
          function() { $(".sidebar-pf").length > 0 && $.fn.sidebar() })
    }(jQuery),
    function($) {
      "use strict";
    ...
    function($) {
      ...
      $.fn.dataTableExt &&
          ($.extend(!0, $.fn.dataTable.defaults, {
            ...
            iDisplayLength : 20,
            sDom :
                "<'dataTables_header' f i r ><'table-responsive'  t ><'dataTables_footer' p >",
            oLanguage : {
              sInfo :
                  "Showing <b>_START_</b> to <b>_END_</b> of <b>_TOTAL_</b> Items",
           ...
           $.fn.dataTableExt.oApi.fnPagingInfo = function(oSettings) {
             return {
               iStart: oSettings._iDisplayStart, iEnd: oSettings.fnDisplayEnd(),
             ...
             bootstrap_input : {
               fnInit : function(oSettings, nPaging, fnDraw) {
                 ...
                 $(nPaging).append(
                     ...
                     els = $("li", nPaging),
                     $(els[0]).bind("click.DT", {action : "first"},
                                    fnClickHandler),
                     $(els[1]).bind("click.DT", {action : "previous"},
                                    fnClickHandler),
                     $(els[2]).bind("click.DT", {action : "next"},
                                    fnClickHandler),
                     $(els[3]).bind("click.DT", {action : "last"},
                                    fnClickHandler),
                     nInput = $("input", nPaging), $(nInput).keyup(function(e) {
                       var iNewStart;
                       if (38 === e.which || 39 === e.which
                         ...
                         if (iNewStart =
                                 oSettings._iDisplayLength * (this.value - 1),
               ...
               fnUpdate : function(oSettings, fnDraw) {
                 var i, oPaging = oSettings.oInstance.fnPagingInfo(),
                        an = oSettings.aanFeatures.p, ien = an.length,
                        iPages = Math.ceil(oSettings.fnRecordsDisplay() /
                                           oSettings._iDisplayLength),
    ...
    function($) {
      ...
      $.fn.navigation = function() {
        var navElement = $(".layout-pf-alt-fixed .nav-pf-vertical-alt"),
            ...
            toggleNavBarButton = $(".navbar-toggle"), explicitCollapse = !1,
            checkNavState = function() {
              ...
              toggleNavBarButton.on("click", function(e) {
                ...
                enableTransitions(),
                    inMobileState && navElement.hasClass("show-mobile-nav")
                        ...
                        : inMobileState ? navElement.addClass("show-mobile-nav")
              ...
              $('.nav-pf-vertical-alt [data-toggle="tooltip"]').tooltip({
                ...
                delay : {show : "500", hide : "200"}
                  ...
                  $(".nav-pf-vertical-alt")
                      .on("show.bs.tooltip",
                          function(e) { return $(this).hasClass("collapsed") })
            }, init = function() {
              checkNavState(), bindMenuBehavior(), setTooltips()
            };
        $(window).on("resize",
                     function() { checkNavState(), enableTransitions() }),
            init()
      }, $(document).ready(function() {
    ...
    function($) {
      ...
      $.fn.countRemainingChars = function(options) {
          ...
          blockInputAtMaxLimit : !1
            ...
            charsRemainingFn = function(charsLength) {
              ...
              $countFld.text(charsRemaining),
                  $countFld.toggleClass("chars-warn-remaining-pf",
                                        charsRemaining <=
                                            settings.charsWarnRemaining),
                  charsRemaining < 0 ? $taFld.trigger("overCharsMaxLimitEvent",
                                                      $taFld.attr("id"))
                                     : $taFld.trigger("underCharsMaxLimitEvent",
                                                      $taFld.attr("id"))
            };
        return this.on("paste",
               ...
               this.keyup(function(
                   event) { charsRemainingFn($taFld.val().length) }),
               this.keydown(function(event) {
                 var charsLength = $taFld.val().length;
                 settings.blockInputAtMaxLimit &&
                     charsLength >= settings.charsMaxLimit &&
                     8 !== event.keyCode && event.preventDefault()
               }),
               this
      }
    }(jQuery),
    ...
    function($) {
      ...
      void 0 !== patternfly &&
          ($.fn.pfSetDonutChartTitle = patternfly.pfSetDonutChartTitle,
           ...
           $.fn.pfGetUtilizationDonutTooltipContentsFn =
               patternfly.pfGetUtilizationDonutTooltipContentsFn,
           $.fn.pfGetBarChartTooltipContentsFn =
               patternfly.pfGetBarChartTooltipContentsFn,
           $.fn.pfSingleLineChartTooltipContentsFn =
               patternfly.pfSingleLineChartTooltipContentsFn,
    ...
    function($) {
      ...
      $.fn.initCollapseHeights = function(scrollSelector) {
        ...
        setCollapseHeights = function() {
          var height, openPanel, contentHeight, bodyHeight,
              overflowY = "hidden";
          ...
          setTimeout(function() {
            parentElement.find('[data-toggle="collapse"]')
                .each($.proxy(
                    function(i, element) {
                      var $element, selector, $target, scrollElement,
                          innerHeight = 0;
                      $element = $(element),
                      selector = $element.attr("data-target"),
                      selector || (selector = $element.attr("href")),
                      $target = $(selector), scrollElement = $target,
                               ...
                               ? (innerHeight = 0,
                                  $target.children()
                                      .each($.proxy(
                                          function(j, sibling) {
                                            var $sibling = $(sibling);
                                            sibling !== scrollElement[0] &&
                                                (innerHeight +=
                                                 $sibling.outerHeight(!0))
                                          },
                                          $target))
                                      .end(),
    ...
    function($) {
      ...
      function getParent(rows, node) {
        ...
        if ("string" == typeof parent)
          return parent = isNaN(parent) ? rows.closest(parent)
                                        : $(rows[parseInt(parent, 10)])
      }
      ...
      $.fn.treegrid = function(options) {
        ...
        rows = this.find("tbody > tr"), _this = this, $.each(rows, function() {
          var node, parent;
          if (node = $(this), parent = getParent(rows, node),
              node.children(".treegrid-node")
                  .prepend('<span class="icon expand-icon fa"/>'),
            ...
            for (i = parent.find(".treegrid-node > span.indent").length + 1;
                 i > 0; i -= 1)
    ...
    function($) {
      ...
      $.fn.setupVerticalNavigation = function(handleItemSelections) {
        var navElement = $(".nav-pf-vertical"),
            ...
            toggleNavBarButton = $(".navbar-toggle"), handleResize = !0,
            explicitCollapse = !1, subDesktop = !1, hoverDelay = 500,
            hideDelay = hoverDelay + 200,
            inMobileState =
                function() { return bodyContentElement.hasClass("hidden-nav") },
            forceResize =
                function(delay) {
              setTimeout(function() { $(window).trigger("resize") }, delay)
            },
            showSecondaryMenu =
                function() {
            ...
            hideSecondaryMenu =
              ...
              navElement.removeClass("secondary-visible-pf"),
                  ...
                  navElement.find(".mobile-nav-item-pf")
                      .each(function(
                          index,
                          item) { $(item).removeClass("mobile-nav-item-pf") })
            },
            setActiveItem =
                function(item) {
            ...
            updateSecondaryMenuDisplayAfterSelection =
                function() {
              inMobileState() ? (navElement.removeClass("show-mobile-nav"),
                                 hideSecondaryMenu(),
                                 navElement.find(".mobile-nav-item-pf")
            ...
            updateSecondaryCollapsedState =
                function(setCollapsed, collapsedItem) {
              setCollapsed
                  ...
                  : (collapsedItem
                         ...
                         : navElement
                               .find('[data-toggle="collapse-secondary-nav"]')
                               .each(function(index, element) {
                                 var $e = $(element);
                                 $e.removeClass("collapsed")
                               }),
                     navElement.removeClass("collapsed-secondary-nav-pf"),
                     bodyContentElement.removeClass(
            ...
            updateTertiaryCollapsedState =
              ...
              setCollapsed
                  ...
                  : (collapsedItem
                         ? collapsedItem.removeClass("collapsed")
                         : navElement
                               .find('[data-toggle="collapse-tertiary-nav"]')
                               .each(function(index, element) {
                                 var $e = $(element);
                                 $e.removeClass("collapsed")
                               }),
            ...
            updateMobileMenu = function(selected, secondaryItem) {
              ...
              navElement.hasClass("hidden") ||
                  (navElement.addClass("hidden"),
                   ...
                   bodyContentElement.addClass("hidden-nav"),
                   updateSecondaryCollapsedState(!1),
                   updateTertiaryCollapsedState(!1), explicitCollapse = !1)
              ...
              handleResize &&
                  (width < $.pfBreakpoints.tablet && !explicitCollapse
                       ? enterMobileState()
                       : navElement.hasClass("hidden") && exitMobileState(),
                   width < $.pfBreakpoints.desktop
                       ...
                       : (makeSecondaryVisible =
                              subDesktop &&
                              navElement.find(".secondary-nav-item-pf.active")
                                      .length > 0,
                          subDesktop = !1,
              ...
              navElement.addClass("collapsed"),
                  bodyContentElement.addClass("collapsed-nav"),
                  subDesktop && hideSecondaryMenu(), explicitCollapse = !0
            }, enableTransitions = function() {
              $("html").addClass("transitions")
            }, expandMenu = function() {
              navElement.removeClass("collapsed"),
                  bodyContentElement.removeClass("collapsed-nav"),
                  explicitCollapse = !1, subDesktop || forceResize(100)
            }, bindMenuBehavior = function() {
              toggleNavBarButton.on("click", function(e) {
                enableTransitions(),
                    inMobileState()
              ...
              $(document).find(".nav-pf-vertical .list-group-item").each(function(index, item) {
                ...
                $nav.hasClass("nav-pf-vertical") ? onClickFn = function(event) {
                  ...
                  $this.hasClass("secondary-nav-item-pf")
                      ...
                      : (hideSecondaryMenu(),
                         inMobileState() &&
                             (updateMobileMenu(),
                              navElement.removeClass("show-mobile-nav")),
                         handleSelection && (setActiveItem($this),
                                             event.stopImmediatePropagation()))
                  ...
                  $this.hasClass("tertiary-nav-item-pf")
                      ...
                      : (inMobileState() &&
                             (updateMobileMenu(),
                              navElement.removeClass("show-mobile-nav")),
                         updateSecondaryMenuDisplayAfterSelection(),
                         handleSelection && (setActiveItem($item),
                                             event.stopImmediatePropagation()))
                            ...
                            function(e) {
                              ...
                              inMobileState()
                                  ...
                                  : $this.hasClass("collapsed")
                                        ? (window.localStorage.setItem(
                                               "patternfly-navigation-secondary",
                                               "expanded"),
                                           window.localStorage.setItem(
                                               "patternfly-navigation-tertiary",
                                               "expanded"),
                                           updateSecondaryCollapsedState(!1,
                                                                         $this),
                                        ...
                                        : (window.localStorage.setItem(
                                           ...
                                           updateSecondaryCollapsedState(
                                               !0, $this)),
                                  navElement.removeClass(
                                      "hover-secondary-nav-pf"),
                                  handleSelection &&
                                      e.stopImmediatePropagation()
                            }),
                            $secondaryItem.find(".tertiary-nav-item-pf")
                  ...
                  $(document).on(
                      ...
                      function(e) {
                        ...
                        void 0 !== $this[0].navHoverTimeout
                            ...
                            : void 0 === $this[0].navUnHoverTimeout &&
                                  ($this[0]
                                       .navUnHoverTimeout = setTimeout(function() {
                                     navElement.find(
                  ...
                  $(document).on(
                      "mouseover.pf.tertiarynav.data-api",
                      ".tertiary-nav-item-pf",
                      function(e) {
                        var $this = $(this);
                        inMobileState() ||
                  ...
                  $(document).on(
                      "mouseout.pf.tertiarynav.data-api",
                      ".tertiary-nav-item-pf", function(e) {
                        var $this = $(this);
                        void 0 !== $this[0].navHoverTimeout
                            ? (clearTimeout($this[0].navHoverTimeout),
                               $this[0].navHoverTimeout = void 0)
              ...
              inMobileState() ||
                  ("collapsed" === window.localStorage.getItem(
                                       "patternfly-navigation-primary") &&
                       collapseMenu(),
                   $(".nav-pf-vertical.nav-pf-vertical-collapsible-menus")
                               .length > 0 &&
                       ("collapsed" ===
              ...
              $('.nav-pf-vertical [data-toggle="tooltip"]')
              ...
              navElement.addClass("hide-nav-pf"),
                  bodyContentElement.addClass("hide-nav-pf"), checkNavState(),
                  bindMenuBehavior(),
                  bindMenuItemsBehavior(handleItemSelections), setTooltips(),
                  loadFromLocalStorage(), navElement.removeClass("hide-nav-pf"),
                  bodyContentElement.removeClass("hide-nav-pf"),
                  forceResize(250)
            }, self = {
              hideMenu : function() { handleResize = !1, enterMobileState() },
              showMenu : function() { handleResize = !0, exitMobileState() },
              isVisible : function() { return handleResize }
            };
        return $.fn.setupVerticalNavigation.self ||
               ...
               $.fn.setupVerticalNavigation.self
      }
    }(jQuery),
    function($) {
      "use strict";
                ...
                $toggles.length || ($toggles = $element),
                    $toggles.on("keydown", function(event) {
                      13 !== event.keyCode && 32 !== event.keyCode ||
                          (toggleCollapse(this), event.stopPropagation(),
