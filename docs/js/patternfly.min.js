!(function (window) {
  ...
  (patternfly.pfPaletteColors = {
    ...
    (patternfly.pfSetDonutChartTitle = function (selector, primary, secondary) {
      var donutChartRightTitle = window.d3
        .select(selector)
    ...
    (patternfly.pfDonutTooltipContents = function (
      d,
      defaultTitleFormat,
      defaultValueFormat,
      color
    ...
    (patternfly.pfPieTooltipContents = function (
      d,
      defaultTitleFormat,
      defaultValueFormat,
      color
    ) {
      return patternfly.pfDonutTooltipContents(
        d,
        defaultTitleFormat,
        defaultValueFormat,
        color
      ...
      var getDefaultColors = function () {
        ...
        getDefaultSparklineTooltip = function () {
          return {
            contents: function (d) {
              return (
                '<span class="c3-tooltip-sparkline">' +
                d[0].value +
                " " +
                d[0].name +
                "</span>"
      ...
      var settings = $.extend(
        ...
        charsRemainingFn = function (charsLength) {
          ...
          $countFld.text(charsRemaining),
            $countFld.toggleClass(
              "chars-warn-remaining-pf",
              charsRemaining <= settings.charsWarnRemaining
            ),
            charsRemaining < 0
                            ...
                            .each(
                              $.proxy(function (j, sibling) {
                                ...
                                sibling !== scrollElement[0] &&
                                  (innerHeight += $sibling.outerHeight(!0));
                              }, $target)
                            )
                            .end(),
    ...
    $.fn.setupVerticalNavigation = function (handleItemSelections) {
      var navElement = $(".nav-pf-vertical"),
        ...
        bindMenuItemsBehavior = function (handleSelection) {
          $(document)
            .find(".nav-pf-vertical .list-group-item")
            .each(function (index, item) {
              var onClickFn,
                $item = $(item),
                $nav = $item.closest('[class*="nav-pf-"]');
              $nav.hasClass("nav-pf-vertical")
                ...
                : $nav.hasClass("nav-pf-secondary-nav")
                ? (onClickFn = function (event) {
                    var $tertiaryItem,
                      $primaryItem,
                      $this = $(this);
                ...
                : $nav.hasClass("nav-pf-tertiary-nav") &&
                  (onClickFn = function (event) {
                    inMobileState() &&
                      (updateMobileMenu(),
                      navElement.removeClass("show-mobile-nav")),
                ...
                void 0 !== $this[0].navHoverTimeout
                  ...
                  : void 0 === $this[0].navUnHoverTimeout &&
                    ($this[0].navUnHoverTimeout = setTimeout(function () {
                      navElement.find(".secondary-nav-item-pf.is-hover")
                        .length <= 1 &&
                        navElement.removeClass("hover-secondary-nav-pf"),
            ...
            $(document).on(
              ...
              function (e) {
                ...
                void 0 !== $this[0].navHoverTimeout
                  ...
                  : void 0 === $this[0].navUnHoverTimeout &&
                    ($this[0].navUnHoverTimeout = setTimeout(function () {
                      navElement.find(".tertiary-nav-item-pf.is-hover")
                        .length <= 1 &&
                        navElement.removeClass("hover-tertiary-nav-pf"),
                        $this.removeClass("is-hover"),
                        ($this[0].navUnHoverTimeout = void 0);
        ...
        loadFromLocalStorage = function () {
          inMobileState() ||
            ("collapsed" ===
              window.localStorage.getItem("patternfly-navigation-primary") &&
              collapseMenu(),
            $(".nav-pf-vertical.nav-pf-vertical-collapsible-menus").length >
              0 &&
              ("collapsed" ===
              ...
              "collapsed" ===
                window.localStorage.getItem("patternfly-navigation-tertiary") &&
  ...
  (function ($) {
    ...
    $.fn.pfList = function () {
      function init(list) {
        list
          .find("[data-list=expansion], .list-pf-item, .list-pf-expansion")
          .each(function (index, element) {
      ...
      function toggleCollapse(toggle) {
        ...
        ($toggle = $(toggle)),
          ($expansion = $toggle
            .parentsUntil(".list-pf", "[data-list=expansion]")
            .first()),
          $expansion.length ||
            ($expansion = $toggle.closest(".list-pf-item, .list-pf-expansion")),
          ($collapse = $expansion.find(".collapse").first()),
