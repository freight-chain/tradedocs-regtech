...
(function (t, n) {
    ...
    return (
      ...
      (e.tickArguments = function (t) {
        return arguments.length
          ? ((i = null == t ? [] : yf.call(t)), e)
          : i.slice();
      }),
      (e.tickValues = function (t) {
        return arguments.length
          ? ((s = null == t ? null : yf.call(t)), e)
          : s && s.slice();
      }),
  ...
  function qt(t) {
    ...
    return new Dt(
      116 * u - 16,
      500 * (o - u),
      200 * (u - Ot((0.0193339 * e + 0.119192 * r + 0.9503041 * i) / Vl)),
      t.opacity
    );
  }
  function Ut(t, n, e, r) {
  ...
  function rn(t) {
    return "none" === t
      ...
      : (oh ||
        ...
        (t = ah
          .getComputedStyle(uh.appendChild(oh), null)
  ...
  function on(t) {
    return null == t
      ? Nh
      : (ch ||
          (ch = document.createElementNS("http://www.w3.org/2000/svg", "g")),
  ...
  function un(t, n, e, r) {
    ...
    function a(t, n, e, o) {
      t !== n
        ? o.push({ i: e.push(i(e) + "skewX(", null, r) - 2, x: mh(t, n) })
        ...
        t.selection
          ...
          : t.each(function () {
              var t = this,
                ...
                c = i(t, o).beforestart();
              ap(t),
                (u.selection = null == a || Ne(a) ? null : a),
                r.call(t),
                c.start().brush().end();
            });
      }),
  ...
  function Vi(t, n, e, r) {
    ...
    return b_(u) > d_
      ? w_(
          (A_(n) * (o = T_(r)) * A_(e) - A_(r) * (i = T_(n)) * A_(t)) /
            (i * o * u)
        )
      : (n + r) / 2;
  }
  ...
  function no(t) {
    ...
    function e(t) {
      return (
        (t = f.invert((t[0] - a) / _, (c - t[1]) / _)) && [t[0] * m_, t[1] * m_]
      );
    }
    function r(t, n) {
  ...
  function Pu(t, n) {
    function e() {
      return (
        (i = Math.min(a.length, c.length) > 2 ? Cu : Au), (o = u = null), r
      );
    }
    function r(n) {
  ...
  function Bu() {
    function n() {
      return (
        (o = Iu(i)), (u = Fu(i)), r()[0] < 0 && ((o = Yu(o)), (u = Yu(u))), e
      );
    }
    ...
    return (
      ...
      e &&
        ((i.count = function (n, r) {
          return (
            Pm.setTime(+n), Lm.setTime(+r), t(Pm), t(Lm), Math.floor(e(Pm, Lm))
          );
        }),
        (i.every = function (t) {
          return (
  ...
  function Gu(t) {
    return Zu(
      ...
      function (t, n) {
        return (
          (n - t - (n.getTimezoneOffset() - t.getTimezoneOffset()) * Um) / Dm
        );
      }
    );
  }
  ...
  function Lc(t, n, e) {
    var r = t._x1 - t._x0,
      ...
      a = (o * i + u * r) / (r + i);
    return (
      (Pc(o) + Pc(u)) * Math.min(Math.abs(o), Math.abs(u), 0.5 * Math.abs(a)) ||
      0
    );
  }
  function Rc(t, n) {
  ...
  function vs(t) {
    var n = t.circle;
    n &&
      (n.P || (Mw = n.N), Sw.remove(n), Ew.push(n), Jc(n), (t.circle = null));
  }
  function _s() {
  ...
  var Ls = function (t, n) {
    ...
    of = function (t, n, e) {
      return (
        (t = $s.call(t, Ys).sort(Ls)),
        Math.ceil(
          (e - n) /
            (2 * (rf(t, 0.75) - rf(t, 0.25)) * Math.pow(t.length, -1 / 3))
        )
      );
    },
    uf = function (t, n, e) {
  ...
  if ("undefined" != typeof document) {
    ...
    if (!Pf.matches) {
      var Lf =
        Pf.webkitMatchesSelector ||
        Pf.msMatchesSelector ||
        Pf.mozMatchesSelector ||
        Pf.oMatchesSelector;
      zf = function (t) {
        return function () {
  ...
  var $f = function (t) {
    ...
    cl = function (t, n, e) {
      ...
      return arguments.length > 1
        ? this.each(
            (null == n ? Y : "function" == typeof n ? j : B)(
              t,
              n,
              null == e ? "" : e
            )
  ...
  var El = function () {
      ...
      function o() {
        if (l.apply(this, arguments)) {
          var n,
            ...
            o = r.length;
          for (n = 0; n < o; ++n)
            (e = c(r[n].identifier, i, Ml, this, arguments)) &&
              (_t(), e("start"));
        }
      }
      function u() {
      ...
      function c(e, r, i, o, u) {
        ...
        if (
          E(
            new yt(n, "beforestart", a, e, g, f[0], f[1], 0, 0, l),
            function () {
              return (
      ...
      return (
        (n.filter = function (t) {
          return arguments.length
            ? ((l = "function" == typeof t ? t : Nl(!!t)), n)
            : l;
        }),
        (n.container = function (t) {
          return arguments.length
            ? ((h = "function" == typeof t ? t : Nl(t)), n)
            : h;
        }),
        (n.subject = function (t) {
          return arguments.length
            ? ((p = "function" == typeof t ? t : Nl(t)), n)
            : p;
        }),
        (n.on = function () {
  ...
  _n.prototype = gn.prototype = {
    ...
    restart: function (t, n, e) {
      ...
      (e = (null == e ? dn() : +e) + (null == n ? 0 : +n)),
        this._next ||
          fh === this ||
          (fh ? (fh._next = this) : (sh = this), (fh = this)),
        (this._call = t),
        (this._time = e),
        wn();
    },
  ...
  var Zh = function (t, n, e) {
    ...
    sp = function (t, n) {
      ...
      if (((t += ""), arguments.length < 2)) {
        for (
          var r, i = kn(this.node(), e).tween, o = 0, u = i.length;
          o < u;
          ++o
        )
  ...
  var Cd = function () {
    function t() {
      ...
      if (
        ...
        u.arc(0, 0, f, l, h),
        (l === _ && h === g) ||
          (u.quadraticCurveTo(0, 0, v * yd(_), v * md(_)),
          u.arc(0, 0, v, _, g)),
  ...
  var zd = function () {
      function t(n, i, u, a) {
        ...
        for (
          var c, s, f, l = -1, h = n.length, p = o[i++], d = Ye(), v = u();
          ++l < h;
  ...
  var Ld = function (t) {
    ...
    uv = function (t) {
      ...
      for (
        this._root &&
        e.push(new tv(this._root, this._x0, this._y0, this._x1, this._y1));
        (n = e.pop());
  ...
  var Pv = function (t) {
    ...
    Rv = function (t, n) {
      return (
        (t = Math.abs(t)), (n = Math.abs(n) - t), Math.max(0, xv(n) - xv(t)) + 1
      );
    },
    qv = function () {
      return new dr();
  ...
  var Uv,
    ...
    B_ = function (t) {
      var n, e, r, i, o, u, a;
      if (
        ((Hv = jv = -(Yv = Bv = 1 / 0)), (Zv = []), q_(t, Y_), (e = Zv.length))
      ) {
  ...
  var $_,
    ...
    ig = function (t) {
      ...
      return (
        ...
        (n.invert = function (n) {
          return (
            (n = t.invert(n[0] * x_, n[1] * x_)), (n[0] *= m_), (n[1] *= m_), n
          );
        }),
        n
      );
    ...
    og = function () {
      ...
      return (
        ...
        (n.radius = function (t) {
          return arguments.length
            ? ((o = "function" == typeof t ? t : X_(+t)), n)
            : o;
        }),
        (n.precision = function (t) {
          return arguments.length
            ? ((u = "function" == typeof t ? t : X_(+t)), n)
            : u;
        }),
        n
      );
    ...
    Gy = function () {
      ...
      return (
        ...
        (t.paddingTop = function (n) {
          return arguments.length
            ? ((c = "function" == typeof n ? n : Dy(+n)), t)
            : c;
        }),
        (t.paddingRight = function (n) {
          return arguments.length
            ? ((s = "function" == typeof n ? n : Dy(+n)), t)
            : s;
        }),
        (t.paddingBottom = function (n) {
          return arguments.length
            ? ((f = "function" == typeof n ? n : Dy(+n)), t)
            : f;
        }),
        (t.paddingLeft = function (n) {
          return arguments.length
            ? ((l = "function" == typeof n ? n : Dy(+n)), t)
            : l;
        }),
        t
      );
    ...
    Cm = function (n, e, i) {
      ...
      switch (((i = lr(null == i ? ",f" : i)), i.type)) {
        case "s":
          ...
          return (
            null != i.precision || isNaN((o = Lv(c, s))) || (i.precision = o),
            t.formatPrefix(i, s)
          );
        case "":
        case "e":
  ...
  var qm = Rm.range,
    ...
    Hm = Zu(
      ...
      function (t, n) {
        return (
          (n - t - (n.getTimezoneOffset() - t.getTimezoneOffset()) * Um) / 864e5
        );
      },
      function (t) {
        return t.getDate() - 1;
    ...
    wb = function () {
      ...
      return (
        ...
        (t.innerRadius = function (e) {
          return arguments.length
            ? ((n = "function" == typeof e ? e : fb(+e)), t)
            : n;
        }),
        (t.outerRadius = function (n) {
          return arguments.length
            ? ((e = "function" == typeof n ? n : fb(+n)), t)
            : e;
        }),
        (t.cornerRadius = function (n) {
          return arguments.length
            ? ((r = "function" == typeof n ? n : fb(+n)), t)
            : r;
        }),
        (t.padRadius = function (n) {
          return arguments.length
            ? ((i = null == n ? null : "function" == typeof n ? n : fb(+n)), t)
            : i;
        }),
        (t.startAngle = function (n) {
          return arguments.length
            ? ((o = "function" == typeof n ? n : fb(+n)), t)
            : o;
        }),
        (t.endAngle = function (n) {
          return arguments.length
            ? ((u = "function" == typeof n ? n : fb(+n)), t)
            : u;
        }),
        (t.padAngle = function (n) {
          return arguments.length
            ? ((a = "function" == typeof n ? n : fb(+n)), t)
            : a;
        }),
        (t.context = function (n) {
    ...
    dw = function () {
      ...
      return (
        ...
        (t.order = function (n) {
          return arguments.length
            ? ((e =
                null == n ? pw : "function" == typeof n ? n : fb(lw.call(n))),
              t)
            : e;
        }),
        (t.offset = function (n) {
  ...
  var qw = function () {
    ...
    Uw = function () {
      ...
      function e(t, n) {
        return (
          (n = Math.max(x, Math.min(b, n))), n === t.k ? t : new Ns(n, t.x, t.y)
        );
      }
      function r(t, n, e) {
        var r = n[0] - e[0] * t.k,
        ...
        function n() {
          qw(),
            ...
            o.zoom(
              "mouse",
              i(
                r(o.that.__zoom, (o.mouse[0] = Ff(o.that)), o.mouse[1]),
                o.extent
              )
            );
        }
      ...
      function l() {
        if (y.apply(this, arguments)) {
          ...
          qw(),
            S > 0
              ? bl(this).transition().duration(S).call(u, f, a)
        ...
        if (y.apply(this, arguments)) {
          ...
          if (_ && ((_ = clearTimeout(_)), !o.touch1))
            return (
              o.end(),
              void (
                (i = bl(this).on("dblclick.zoom")) && i.apply(this, arguments)
              )
            );
          n &&
